    ...
    _createClass(Orbs, [{
      ...
      value: function createOrbs() {
        ...
        for (var i = 1; i <= this.amount; i++) {
          var randomLeftStart = input.randomize(101) - 1;
          var randomTopStart = input.randomize(101) - 1;
          var randomLeftEnd = input.randomize(101) - 1;
          var randomTopEnd = input.randomize(101) - 1;
